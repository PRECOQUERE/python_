...
with open('day-24-start-Mail_Merge/Mail Merge Project Start/Input/Letters/starting_letter.txt', mode='r') as letter :
...
for dear in list_dear:
    ...
    with open(f'day-24-start-Mail_Merge/Mail Merge Project Start/Output/ReadyToSend/{dear}.txt', mode='w') as file:
